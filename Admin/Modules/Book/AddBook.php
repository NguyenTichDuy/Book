								...
								<form action="" method="post" id="main-form">
									<div class="card border-dark">
										...
										<div class="card-body">
											<div class="row">
												<div class="col-xs-9 col-sm-9 col-md-9 col-lg-9 form-group">
													<label>Mã Sách</label>
													<input type="text" name="txtidbook" class="form-control border-dark">
												</div>
											</div>
											<div class="row">
												<div class="col-xs-9 col-sm-9 col-md-9 col-lg-9 form-group">
													<label>Tên Sách</label>
													<input type="text" name="txtnamebook" class="form-control border-dark">
												</div>
											</div>
											<div class="row">
												<div class="col-xs-9 col-sm-9 col-md-9 col-lg-9 form-group">
													<label>Tác giả</label>
													<input type="text" name="txtauthor" class="form-control border-dark">
												</div>
											</div>
											<div class="row">
												<div class="col-xs-9 col-sm-9 col-md-9 col-lg-9 form-group">
													<label>Nhà xuất bản</label>
													<input type="text" name="txtnxb" class="form-control border-dark">
												</div>
											</div>
											<div class="row">
												<div class="col-xs-9 col-sm-9 col-md-9 col-lg-9 form-group">
										...
										<div class="card-footer bg-info border-dark">
											...
											<input class="btn btn-info" type="submit" value="Thêm"> <a class="btn btn-info" href="<?php echo $tBook->h->get_url('book/admin/?m=book&a=listbook'); ?>">Trở Về</a>
										</div>
									</div>
								</form>
							</div>
