          ...
          ?>
					<div>
                        ...
                        Bạn có thật sự muốn xóa tên sách này không ?
										...
										<p class="card-text text-center"> <b style="font-size:30px;"> <?php  echo $name['TENSACH']; ?></b>
										</p>
									</div>
									<form action="" method="post">
										<div class="card-footer bg-danger pt-2 pb-2 text-center">
											<input type="hidden" name="request_name" value="delete_book">
											<input type="submit" class="btn btn-info" value="Có"> <a href="<?php echo $book->h->get_url('book/admin/?m=book&a=listbook'); ?>" class="btn btn-info">Không</a>
										</div>
									</form>
								</div>
							</div>
