    ...
    <div class="row mt-4 mb-4">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="card border-dark">
                ...
                <div class="card-body">
                    <div>
                        <a href="<?php echo $book->h->get_url('book/admin/?m=book&a=addbook'); ?>" class="btn btn-info">Thêm Sách</a>
                    </div>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo $book->h->get_url('book/admin/?m=book&a=editbook&id=' . $row['MASACH']); ?>" class="btn btn-outline-danger">Sửa</a>
