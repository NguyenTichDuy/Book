						...
						<div class="row mt-4 mb-4">
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
								<div class="card border-dark">
									...
									<div class="card-body">
										<div> <a href="<?php echo $book->h->get_url('book/admin/?m=posts&a=addposts'); ?>" class="btn btn-info">Thêm Sách</a>
										</div>
										<table class="table table-bordered mt-3">
											...
											<tbody>
												...
												<tr>
													...
													<td>
														<?php echo $row[ 'NGAYSUA'] ?>
													</td>
													<td>
														<?php echo $row[ 'TENSACH'] ?>
													</td>
													<td> <a href="<?php echo $book->h->get_url('book/admin/?m=posts&a=editposts&id=' . $row['MABAIVIET']); ?>" class="btn btn-outline-danger">Sửa</a>
