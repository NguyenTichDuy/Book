	...
	<main class="container-fluid">
			...
			<div class="col span-3-of-12">
				<div class="sidebar">
					<center>
						...
						<h4>Admin</h4>
					</center> <a href="#"><i class="fas fa-book-medical"></i><span>Loại sách</span></a>
		...
		<div class="row">
          ...
          <?php 
              ...
              if ($type_book->h->is_submit('add_type') && $type_book->db_insert_type($data)) 
              { 
								...
								<form action="" method="post" id="main-form">
									<div class="card border-dark">
										...
										<div class="card-footer bg-info border-dark">
											...
											<input class="btn btn-info" type="submit" value="Thêm"> <a class="btn btn-info" href="<?php echo $type_book->h->get_url('book/admin/?m=typebook&a=listtypebook'); ?>">Trở Về</a>
										</div>
									</div>
								</form>
							</div>
