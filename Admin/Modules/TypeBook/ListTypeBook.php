	...
	<main class="container-fluid">
		...
		<div class="row">
          ...
          <?php 
              ...
              $list=$type_book->db_get_list_type_book(); 
          ?>
					<div>
						<div class="row mt-4 mb-4">
							<div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
								<div class="card border-dark">
									...
									<div class="card-body">
										<div> <a href="<?php echo $type_book->h->get_url('book/admin/?m=typebook&a=addtypebook'); ?>" class="btn btn-info">Thêm Loại Sách</a>
										</div>
										<table class="table table-bordered mt-3">
											...
											<tbody>
												...
												<tr>
													...
													<td> <a href="<?php echo $type_book->h->get_url('book/admin/?m=typebook&a=edittypebook&id=' . $row['MALOAI']); ?>" class="btn btn-outline-danger">Sửa</a>
														<a href="<?php echo $type_book->h->get_url('book/admin/?m=typebook&a=deletetypebook&id=' . $row['MALOAI']); ?>" class="btn btn-outline-danger">Xóa</a>
													</td>
												</tr>
												<?php $stt++; } ?>
											</tbody>
